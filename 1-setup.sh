...
GITHUB="https://raw.githubusercontent.com/aleemladha/Guacamole-Install/main"
...
#######################################################################################################################
SERVER_NAME="vagrant"                  # Server hostname. (Blank = use the current hostname.)
...
MYSQL_ROOT_PWD="123456"               # Requires an entry here or at script prompt.
GUAC_PWD="123456"                     # Requires an entry here or at script prompt.
...
GUAC_URL_REDIR="http://localhost:8080/guacamole"           # Add auto redirect from http://xxx:8080 root to http://xxx:8080/guacamole)
